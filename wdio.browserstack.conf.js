...
export const config = {
  ...
  baseUrl: `https://service-manual-journey-ui-tests.${process.env.ENVIRONMENT}.cdp-int.defra.cloud`,
  ...
  commonCapabilities: {
    'bstack:options': {
      buildName: `service-manual-journey-ui-tests-${process.env.ENVIRONMENT}` // configure as required
    }
  },
    ...
    [
      'browserstack',
      {
        ...
        testObservabilityOptions: {
          ...
          buildName: `service-manual-journey-ui-tests-${process.env.ENVIRONMENT}`
        },
